...
<head>
	...
	<link rel="stylesheet" href="<?php get_template_directory(); ?>/css/style.css">
...
<div class="menu_xs">
	...
	<div class="menu_xs__item menu_xs__item_middle">
		...
		<div class="menu_xs__item_middle_box1">
			<img class="img-responsive" src="<?php get_template_directory(); ?>/img/di-logo-m.png" alt="">
		</div>
...
<div class="menu_md">
	<div class="container">	
		<div class="menu_md__left">
			<img src="<?php get_template_directory(); ?>/img/di-logo-d.png" alt="">
		</div>	
